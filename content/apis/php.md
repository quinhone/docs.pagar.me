...
Para iniciar sua integração backend vamos seguir 5 passos.
...
### Passo 3 - Postback
Quando um boleto for emitido nosso sistema vai criar uma transação com o status `waiting_payment`
